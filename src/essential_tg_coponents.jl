...
#! Do we need this here? Better someplace else? Probably...
...
function formulate_milp(
    ...
    extra_constraints=nothing, # RESPEC: verified LLM re-specification (RespecProposal) or nothing
    kwargs...
)
